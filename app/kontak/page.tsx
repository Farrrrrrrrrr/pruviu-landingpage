      ...
      <section className="container mx-auto px-6 py-20">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <h1 className="text-5xl font-bold text-navy-700 mb-4">Hubungi Kami</h1>
            <p className="text-xl text-gray-600">Kami siap membantu Anda dengan pertanyaan dan kebutuhan Anda</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow border-2 border-blue-100">
              <div className="flex flex-col items-center text-center space-y-6">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-navy-700 mb-2">Email Support</h3>
                  <p className="text-gray-600 mb-6">Kirim email kepada kami untuk pertanyaan detail atau bantuan teknis</p>
                </div>
                <a 
                  href="mailto:support@pruviu.com" 
                  className="inline-flex items-center space-x-2 px-8 py-4 bg-navy-600 text-white rounded-lg hover:bg-navy-700 transition-colors font-medium text-lg shadow-md"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <span>support@pruviu.com</span>
                </a>
              </div>
            </div>

            {/* WhatsApp Contact Card */}
            <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow border-2 border-green-100">
              <div className="flex flex-col items-center text-center space-y-6">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-navy-700 mb-2">WhatsApp</h3>
                  <p className="text-gray-600 mb-6">Hubungi kami via WhatsApp untuk pertanyaan cepat dan konsultasi langsung</p>
                </div>
                <a 
                  href="https://wa.me/6281234567890?text=Halo%20Pruviu,%20saya%20ingin%20bertanya%20mengenai%20layanan%20Anda" 
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center space-x-2 px-8 py-4 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors font-medium text-lg shadow-md"
                >
